		...
		<div class="footer-blocks container">
			<div class="footer-block-item">
				<div class="contact">
					...
					<p>
						...
						<a href="tel:555358235231">778-456-7891</a>
					</p>
					<p>
						<span>
			...
			<div class="text-logo">
				<a href=''>
					...
					<img class='home-hero-logo' src="<?php echo get_template_directory_uri() . '/images/logos/inhabitent-logo-text.svg'; ?>"
					  alt='White inhabitent logo'>
				</a>
			</div>
		</div>
		<div class="site-info">
