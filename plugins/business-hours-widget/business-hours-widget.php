 ...
 * @author    Dylan Kocsis <dylan.kocsis@queensu.ca>
 * @license   GPL-2.0+
 * @link      http://example.com
 * @copyright 2017 Dylan Kocsis
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent Business Hours Widget
 * Plugin URI:        @TODO
 * Description:       Business Hours Widget built for the Inhabitent site.
 * Version:           1.0.0
 * Author:            Dylan Kocsis
 * Author URI:        @TODO
 * License:           GPL-2.0+
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Adds the store business hours.'
			)
		);
